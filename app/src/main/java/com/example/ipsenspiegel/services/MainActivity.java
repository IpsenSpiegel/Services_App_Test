package com.example.ipsenspiegel.services;
    ...
    public void onClick(View vClicked) {
        switch (vClicked.getId()) {
            case R.id.btnDispInfo:
                Log.i(MainActivity.TAG_ACTIVITY_ID, "Display Button clicked");
            ...
            case R.id.btnStartService:
                Log.i(MainActivity.TAG_ACTIVITY_ID, "Start Service Button clicked");
            ...
            case R.id.btnStartBoundService:
                Log.i(MainActivity.TAG_ACTIVITY_ID, "Start bound Service Button clicked");
            ...
            case R.id.btnStartIntentService:
                Log.i(MainActivity.TAG_ACTIVITY_ID, "Starting IntentService Button clicked");
